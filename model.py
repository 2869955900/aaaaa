...
# Streamlit 用户界面
st.title("Lymphoma Prediction App")
...
if st.button("Predict"):
    ...
    if predicted_class == 1:
        advice = (
            f"According to our model, you have a high risk of lymphoma. "
            f"The model predicts that your probability of having lymphoma is {probability:.1f}%. "
            "We recommend consulting with a healthcare provider for further tests and evaluation."
        )
    else:
        advice = (
            f"According to our model, you have a low risk of lymphoma. "
            f"The model predicts that your probability of not having lymphoma is {probability:.1f}%. "
